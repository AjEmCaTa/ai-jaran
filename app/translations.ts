export const translations = {
  bs: {
    ...
    hero: {
      ...
      description: "Dok ti odmaraš ili radiš, tvoj AI Jaran dogovara termine i prodaje tvoje usluge.",
      ...
      items: [
        {
          ...
          desc: "Klijenti mogu zakazati termin direktno kroz interakciju. Sistem provjerava slobodne termine u kalendaru i bilježi rezervaciju bez tvog uplitanja.",
        },
        {
          title: "Izrada Web Stranice",
          desc: "Pravimo modernu, brzu i custom web stranicu po želji klijenta koja savršeno predstavlja njegov biznis i privlači nove kupce.",
        },
        {
          title: "Automatsko Odgovaranje",
          desc: "Trenutne notifikacije i odgovori na poruke putem Telegrama, Instagrama ili WhatsApp-a. Nijedan klijent više neće ostati bez odgovora.",
        },
        {
          title: "Prilagođeno Vašem Biznisu",
          desc: "Bilo da se radi o uslužnoj djelatnosti, čišćenju ili salonima, AI Jaran se u potpunosti konfiguriše i kroji tačno po mjeri vašeg poslovanja.",
        },
      ],
    },
    benefits: {
  ...
  en: {
    ...
    hero: {
      ...
      description: "While you rest or work, your AI Buddy books appointments and sells your services.",
      ...
      items: [
        {
          ...
          desc: "Clients can book appointments directly through interaction. The system checks available slots in the calendar and logs bookings without your intervention.",
        },
        {
          title: "Website Development",
          desc: "We build modern, fast, and custom websites tailored to client preferences that perfectly represent their business and attract new customers.",
        },
        {
          title: "Automatic Replies",
          desc: "Instant notifications and replies via Telegram, Instagram, or WhatsApp. No customer will ever be left without a response.",
        },
        {
          title: "Tailored to Your Business",
          desc: "Whether it's a service industry, cleaning, or salons, AI Buddy is fully configured and tailored to your exact business needs.",
        },
      ],
    },
    benefits: {
